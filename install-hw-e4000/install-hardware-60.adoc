...
---
= Instala el hardware de un sistema de almacenamiento E4060
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Una estantería vacía pesa aproximadamente 134 lb (61 kg). Se necesita un elevador mecanizado o cuatro personas usando asideros de elevación para mover una estantería vacía de forma segura.
