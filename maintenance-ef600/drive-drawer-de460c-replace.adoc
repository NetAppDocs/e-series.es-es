...
summary: En los sistemas de almacenamiento EF300 y EF600, puedes reemplazar un cajón de unidades en una bandeja de expansión DE460C cuando la bandeja de unidades está en línea o fuera de línea. 
---
= Reemplaza la bandeja de unidades en un DE460C - EF300 y EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
En los sistemas de almacenamiento EF300 y EF600, puedes reemplazar un cajón de unidades en una bandeja de expansión DE460C cuando la bandeja de unidades está en línea o fuera de línea.
