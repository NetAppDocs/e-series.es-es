...
---
= Agrega una tarjeta de expansión SAS a un controlador EF300 o EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. En la página de inicio de SANtricity System Manager, selecciona menú:storage[Operations in Progress]. Espera a que finalicen todas las operaciones antes de continuar con el siguiente paso.
