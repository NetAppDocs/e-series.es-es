...
---
= Cambiar el protocolo de host en un sistema de almacenamiento EF300 o EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.. Selecciona la pestaña *Recursos de asistencia*.
...
. En la página de inicio de SANtricity System Manager, selecciona menú:Storage[Operations in Progress].
