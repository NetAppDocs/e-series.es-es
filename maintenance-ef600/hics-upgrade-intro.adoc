...
---
= Actualiza el HIC en un sistema de almacenamiento EF300 o EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. En SANtricity System Manager, selecciona menú:Storage[Operations in Progress]. Espera a que finalicen todas las operaciones antes de continuar con el siguiente paso.
