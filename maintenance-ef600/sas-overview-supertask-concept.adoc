...
---
= Requisitos para la sustitución de la tarjeta de expansión SAS en EF300 y EF600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Para los controladores EF300 y EF600, la tarjeta de expansión SAS debe instalarse en el puerto 1 para permitir la expansión de la bandeja de unidades.
