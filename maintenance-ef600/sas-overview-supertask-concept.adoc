...
* En el caso de los controladores EF300, la tarjeta de expansión SAS debe instalarse en el puerto 1 para permitir la expansión de las bandejas de unidades.
