...
---
= Bandejas compatibles con el armario E-Series 3040 de 40U
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes instalar las siguientes bandejas de unidad controladora y bandejas de unidad de expansión en el armario E-Series 3040 40U.

Si tus bandejas de unidad controladora o las bandejas de unidad de expansión no están en la lista de abajo, consulta https://hwu.netapp.com["Hardware Universe de NetApp"^] para verificar si tus bandejas de unidad controladora o las bandejas de unidad de expansión son compatibles.
