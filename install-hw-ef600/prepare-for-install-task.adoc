...
---
= Prepárate para instalar tu sistema de almacenamiento EF300 o EF600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Puedes registrar tu sistema ahora o más adelante. Más adelante, al iniciar el sistema, se te pedirá que registres tu sistema.
...
|===
+
En la siguiente tabla se indican los tipos de cables que puedes recibir. Si recibes un cable que no aparece en la tabla, consulta link:https://hwu.netapp.com["Hardware Universe de NetApp"^] para localizar el cable e identificar su uso.
