...
---
= Verifica el acceso al almacenamiento en un host de Windows en E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Desde SANtricity System Manager, ve a *Storage* > *Volumes* y luego selecciona el *ellipsis icon* > *Change volume ownership*.
