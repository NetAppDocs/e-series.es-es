...
---
= Configura conexiones iSCSI para hosts Windows en E-Series
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
* Dos redes separadas para alta disponibilidad. Asegúrate de aislar tu tráfico iSCSI en segmentos de red separados de otros tipos de tráfico usando VLAN o dos redes separadas.
...
Esta tarea describe cómo acceder a la configuración de puertos iSCSI desde la página Hardware. También puedes acceder a la configuración desde menu:Settings[Sistema > Configurar puertos iSCSI].
