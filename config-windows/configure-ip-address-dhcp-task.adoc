...
summary: 'Utiliza el Protocolo de configuración dinámica de host (DHCP) para proporcionar direcciones IP en el método exprés de Windows.' 
---
= Configura direcciones IP usando DHCP para hosts Windows en E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
