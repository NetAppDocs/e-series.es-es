...
---
= Hardware E-Series y software SANtricity: Versiones anteriores
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html["Ayuda de System Manager"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html["Ayuda de Unified Manager"^]
