...
summary: Sustituye un módulo de ventilador en tu sistema de almacenamiento EF50 o EF80 cuando un ventilador falle o no funcione de forma eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general. 
---
= Sustituir un módulo de ventilador en un sistema de almacenamiento EF50 o EF80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de ventilador en tu sistema de almacenamiento EF50 o EF80 cuando un ventilador falle o no funcione de forma eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.

.Acerca de esta tarea
* Sustituye un ventilador preparando, poniendo el controlador dañado fuera de línea, quitando el controlador, cambiando el ventilador, reinstalando el controlador, poniéndolo en línea, completando la sustitución y devolviendo la unidad con error a NetApp.
* Debes poner el controlador dañado en modo offline antes de desenchufar cualquiera de sus cables.
* Cada controlador incluye cinco ventiladores. Si falla un ventilador, tienes que reemplazarlo lo antes posible para asegurarte de que el controlador tenga una refrigeración adecuada.
...
== Paso 1: prepárate para sustituir un ventilador

Prepárate para sustituir un ventilador confirmando que está bien sustituirlo, reuniendo las herramientas y el equipo necesarios, y haciendo una copia de seguridad de la base de datos de configuración del sistema de almacenamiento.
...
== Paso 4: reemplazar un ventilador

Localiza el ventilador defectuoso dentro del controlador deteriorado y reemplázalo.
...
== Paso 7: completa la sustitución del ventilador
