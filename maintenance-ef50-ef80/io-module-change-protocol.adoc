...
---
= Cambiar el protocolo del módulo de E/S del host en un sistema EF50 o EF80
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
Para obtener instrucciones, consulta el https://docs.netapp.com/us-en/e-series-santricity/sm-storage/create-host-manually.html["Crear un host manualmente en SANtricity System Manager"^] procedimiento.
