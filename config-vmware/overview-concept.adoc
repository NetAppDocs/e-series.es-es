...
|===
Si estas suposiciones no son correctas para la instalación o si desea obtener información de fondo conceptual, consulte el siguiente informe técnico: https://www.netapp.com/us/media/tr-4789.pdf["Guía de configuración de VMware para la integración de iSCSI de SANtricity E-Series con ESXi 6.X."^]
