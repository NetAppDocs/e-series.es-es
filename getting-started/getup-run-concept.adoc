...
Para instalar el hardware E-Series, accede a las instrucciones de instalación y configuración de tu matriz de almacenamiento y tipo de shelf (si aplica):

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["Sistema de almacenamiento EF50 o EF80"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["Ayuda en línea de SANtricity System Manager para 12.0x"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["Ayuda en línea de SANtricity System Manager para 11,9x"^]
