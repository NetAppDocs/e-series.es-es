...
---
= Contenido incluido en esta documentación de E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Es posible que se admitan interfaces y sistemas operativos adicionales. Para obtener más información, póngase en contacto con el soporte técnico.
 ...
 a| 
Esta página web _no_ incluye información sobre versiones _anteriores a_ la versión 11.50 del software o la versión 8.50 del firmware. Para consultar versiones anteriores, ve a la  https://docs.netapp.com/us-en/e-series-santricity/early-versions.html#software-documentation-for-earlier-releases["Documentación de E-Series y SANtricity para versiones anteriores"^] página.
