...
---
= Conoce el software SANtricity para E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Unified Manager es un programa basado en web que se utiliza para gestionar todo tu dominio. Desde una vista central, puedes ver el estado de todas las matrices más recientes de E-Series y EF-Series, como la EF50, EF80, E4000, EF300, EF600, EF300C y EF600C. También puedes realizar operaciones por lotes en las matrices de almacenamiento seleccionadas.
...
La interfaz de línea de comandos (CLI) es una aplicación de software que proporciona una forma de configurar y supervisar las matrices de almacenamiento. Usando la CLI, puedes ejecutar comandos desde un indicador del sistema operativo, como el indicador `DOS C:`, una ruta del sistema operativo Linux o una ruta del sistema operativo Solaris.
