...
+
.. Seleccione *hardware*.
.. Mira la potencia image:../media/sam1130_ss_hardware_power_icon_maint-e5700.gif[""] y ventilador image:../media/sam1130_ss_hardware_fan_icon_maint-e5700.gif[""] Iconos a la derecha de las listas desplegables *Shelf* para determinar qué estante tiene la fuente de alimentación fallida.
+
...
+
image::../media/28_dwg_913w_power_supply_back_view_maint-e5700.gif[28 dwg 913w fuente de alimentación vista posterior mant e5700]

+
** Si el LED de alimentación image:../media/drw_sas_power_icon_maint-e5700.gif[""] es *verde sólido*, la fuente de alimentación funciona correctamente. Si está *Off*, la fuente de alimentación ha fallado, el interruptor de CA está apagado, el cable de alimentación de CA no está instalado correctamente o la tensión de entrada del cable de alimentación de CA no está dentro del margen (hay un problema en el extremo de la fuente del cable de alimentación de CA).
+
Si el LED de atención image:../media/drw_sas_fault_icon_maint-e5700.gif[""] es *ámbar fijo*, la fuente de alimentación o su ventilador integrado tienen un fallo.
