...
+
image::../media/e5700_mac_address_and_fru_part_number.png[dirección mac y número de pieza de la unidad reemplazable del sector de e5700]
...
+
.. Seleccione *hardware*.
.. Localice la bandeja de controladoras, que se Marca con el icono de la controladora image:../media/sam1130_ss_hardware_controller_icon_maint-e5700.gif[""].
...
. Si es necesario, redistribuya los volúmenes de vuelta a su propietario preferido.
+
