...
---
= Sustituir el cajón de unidades: E5700 (60 unidades)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e5700.gif[Color naranja para liberar el asa del compartimento de ventilador]
...
+
image::../media/trafford_cable_rail_1_maint-e5700.gif[Cadena de cables y conectores para el cajón de transmisión]
...
+
image::../media/trafford_cable_rail_3_maint-e5700.gif[Anillo naranja para el riel vertical y la cadena de cables para el cajón de la unidad]
...
+
image::../media/trafford_cable_rail_2_maint-e5700.gif[Anillo naranja para el riel horizontal y la cadena de cables para el cajón de la unidad]
...
+
image::../media/dwg_trafford_drawer_with_hdds_callouts_maint-e5700.gif[Números de ranura de unidad]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilice las asas de leva para quitar la unidad]
...
+
image::../media/92_pht_de6600_drive_drawer_release_lever_maint-e5700.gif[Suelte la palanca para extraer el cajón]
...
+
image::../media/92_pht_de6600_lock_out_tumbler_detail_maint-e5700.gif[Vaso de bloqueo y guía del cajón]
...
+
image::../media/2860_dwg_both_guide_rails_maint-e5700.gif[Rieles guía horizontales y verticales]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilice el asa para bajar la unidad al cajón]
