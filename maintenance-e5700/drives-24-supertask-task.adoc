...
summary: Sustituya una unidad en una bandeja de 24 unidades E5700. 
---
= Sustituye una unidad en un bastidor de 24 unidades del modelo E5700
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es posible sustituir una unidad en una bandeja de 24 unidades.
...
+
image::../media/drw_drive_latch_maint-e5700.gif[Pulse el botón de liberación para quitar la unidad con error]
