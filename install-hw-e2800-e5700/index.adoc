...
---
= Flujo de trabajo de instalación y configuración para los sistemas de almacenamiento E2800 y E5700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Los sistemas de almacenamiento E2800 y E5700 son productos fuera de comercialización (EOA) y ya no están disponibles para su compra, pero todavía cuentan con soporte. La información de esta sección se proporciona solo como referencia.
