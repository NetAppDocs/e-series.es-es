...
. Si se abre el cuadro de diálogo Resolve Self-Signed Certificates, revisa la información mostrada para los certificados no fiables. Para más información, también puedes hacer clic en la elipsis al final de la tabla y seleccionar *View* en el menú emergente.
. Debe realizar una de las siguientes acciones:
+
