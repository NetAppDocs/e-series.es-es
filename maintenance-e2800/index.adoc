...
---
= Realiza el mantenimiento del hardware de un sistema de almacenamiento E2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Los sistemas de almacenamiento E2800 son productos fuera de comercialización (EOA) y ya no están disponibles para su compra, pero todavía cuentan con soporte. La información de esta sección se proporciona solo como referencia.
