...
---
= Sustituir un controlador en una configuración dúplex de E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
... Seleccione *hardware*.
... Si el gráfico muestra las unidades, selecciona *Mostrar parte posterior de la estantería* para mostrar los controladores
