...
---
= Sustituye una unidad en un bastidor de 60 unidades del modelo E2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es posible sustituir una unidad en un E2800 con una bandeja de 60 unidades.
...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e2800.gif[LED de atención en el cajón de unidades E2800]
...
+
image::../media/2860_dwg_amber_on_drive_maint-e2800.gif[LED de atención en el cajón de unidades E2800]
...
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e2800.gif[El icono de atención y el LED del cajón de unidades]
...
+
image::../media/trafford_drive_rel_button_maint-e2800.gif[Pestillo de desbloqueo naranja en el cajón de unidades]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e2800.gif[Utilice la palanca de leva para levantar la transmisión de la bandeja]
