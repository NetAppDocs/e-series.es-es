...
---
= Completa la conversión del protocolo del host para una cabina E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Haz clic en el interruptor y selecciona *Configurar puertos iSCSI*.
...
.. Seleccione el host al que se asociará el puerto y haga clic en *Ver/editar configuración*.
+
Aparece el cuadro de diálogo Editar configuración del host.
