...
---
= Sustituye la fuente de alimentación en un shelf E2800 de 12 o 24 unidades
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
.. Seleccione *hardware*.
.. Fíjate en los iconos de alimentación image:../media/sam1130_ss_hardware_power_icon_maint-e2800.gif["Icono de encendido"] y del ventilador image:../media/sam1130_ss_hardware_fan_icon_maint-e2800.gif["Icono de ventilador"] a la derecha de las listas desplegables *Shelf* para saber en qué estante está la fuente de alimentación con error.
+
