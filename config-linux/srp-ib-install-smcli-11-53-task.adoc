...
summary: 'Al instalar el software SANtricity Storage Manager en la estación de administración, se instalan de forma predeterminada una interfaz gráfica de usuario \(GUI\) y una interfaz de línea de comandos \(CLI\). Estas instrucciones dan por sentado que instalará la interfaz gráfica de usuario de SANtricity Storage Manager en una estación de administración y no en el host de I/O.' 
---
= Instalar SANtricity Storage Manager para SMcli (11,53 o anterior) - Linux (SRP over InfiniBand)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
