...
summary: 'Al instalar el software SANtricity Storage Manager en tu estación de gestión, se instalan de forma predeterminada una interfaz gráfica de usuario (GUI) y una interfaz de línea de comandos (CLI). Estas instrucciones asumen que vas a instalar la GUI de SANtricity Storage Manager en una estación de gestión y no en el host de E/S.' 
---
= Instala SANtricity Storage Manager para SMcli en hosts Linux E-Series
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
