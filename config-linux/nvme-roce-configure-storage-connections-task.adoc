...
---
= Configura las conexiones RoCE de la matriz de almacenamiento E-Series para hosts Linux
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que configures los ajustes del puerto NVMe sobre RoCE, link:nvme-roce-discover-connect-storage-host-task.html["detectar y conectar el almacenamiento en el host"].
