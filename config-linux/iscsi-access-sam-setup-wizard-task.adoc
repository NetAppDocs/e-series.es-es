...
---
= Configuración del almacenamiento mediante System Manager de SANtricity - Linux (iSCSI)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Si es un usuario de iSCSI, debe cerrar el asistente de configuración al configurar iSCSI.
