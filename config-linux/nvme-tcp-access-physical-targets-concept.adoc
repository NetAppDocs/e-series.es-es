...
---
= Cómo acceden los hosts Linux a los volúmenes NVMe en objetivos E-Series a través de TCP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Con las operaciones de E/S dirigiéndose a los dispositivos NVMe, link:nvme-tcp-create-filesystems-sles-15-task.html["crear los sistemas de archivos"].
