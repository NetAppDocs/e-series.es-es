...
summary: 'Utiliza el Protocolo de configuración dinámica de host (DHCP) para proporcionar direcciones IP.' 
---
= Configura direcciones IP usando DHCP para hosts NVMe over TCP de E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que configures las direcciones IP usando DHCP, link:nvme-tcp-access-sam-setup-wizard-task.html["Configura tu almacenamiento usando SANtricity System Manager"].
