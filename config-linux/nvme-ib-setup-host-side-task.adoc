...
---
= Configura un iniciador NVMe sobre InfiniBand en un host Linux E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Antes de empezar
Debe estar ejecutando el último sistema operativo compatible con RHEL 8, RHEL 9, RHEL 10, SLES 12, SLES 15 o SLES 16. Ver el https://mysupport.netapp.com/matrix["Herramienta de matriz de interoperabilidad de NetApp"^] para obtener una lista completa de los requisitos más recientes.
