...
---
= Crear un host NVMe sobre TCP de Linux E-Series en SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Haz clic en *+Add Host Port* para acceder al campo «Puertos de host» y añadir los identificadores de puerto de host. Puedes añadir uno o varios identificadores de puerto de host para asociarlos al host.
...
Tipo de sistema operativo de host
 a| 
Selecciona la siguiente opción en la lista desplegable:
...
.El futuro
Una vez creado el host, link:nvme-tcp-assign-volume-task.html["asignar un volumen a través de SANtricity System Manager"].
