...
summary: En SLES 12, se crea un sistema de archivos en el espacio de nombres y se monta el sistema de archivos. 
---
= Crear sistemas de archivos en hosts Linux SLES 12 E-Series con NVMe sobre InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
En SLES 12, se crea un sistema de archivos en el espacio de nombres y se monta el sistema de archivos.
