...
summary: 'Configurar (dividir en zonas) los switches de Fibre Channel (FC) permite que los hosts se conecten a la cabina de almacenamiento y limita el número de rutas. Debe dividir los switches de mediante la interfaz de gestión de los switches de en zonas.' 
---
= Configura los conmutadores FC para hosts E-Series Linux NVMe over FC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
