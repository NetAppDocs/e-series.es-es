...
---
= Configura direcciones IP usando DHCP para hosts iSER de E-Series con Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Un servidor DHCP instalado y configurado en la misma subred que los puertos de gestión de almacenamiento.
