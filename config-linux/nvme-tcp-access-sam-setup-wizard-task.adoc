...
---
= Configura tu matriz de almacenamiento E-Series mediante el asistente de configuración de SANtricity
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
SANtricity System Manager es una interfaz basada en web integrada en cada controlador. Para acceder a la interfaz de usuario, tienes que introducir la dirección IP del controlador en el navegador. Un asistente de configuración te ayuda a dar los primeros pasos en la configuración del sistema.
...
.El futuro
Después de que configures el almacenamiento en SANtricity System Manager, link:nvme-tcp-configure-switch-task.html["configurar los conmutadores"].
