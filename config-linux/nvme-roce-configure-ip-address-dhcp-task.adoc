...
---
= Configura direcciones IP usando DHCP para NVMe sobre RoCE en E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que configures las direcciones IP usando DHCP, link:nvme-roce-access-sam-setup-wizard-task.html["Configura tu almacenamiento usando SANtricity System Manager"].
