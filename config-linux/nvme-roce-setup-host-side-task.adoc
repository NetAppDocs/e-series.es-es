...
.Antes de empezar
Debe estar ejecutando el último sistema operativo compatible RHEL 8, RHEL 9, SUSE Linux Enterprise Server 12 o 15 service pack. Consulte https://mysupport.netapp.com/matrix["Herramienta de matriz de interoperabilidad de NetApp"^] para la lista completa de los últimos requisitos.
