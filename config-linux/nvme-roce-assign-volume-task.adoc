...
summary: 'Es necesario asignar un volumen (espacio de nombres) a un host o un clúster de hosts para que se pueda usar en operaciones de I/O. Esta asignación otorga a un host o un clúster de hosts acceso a uno o varios espacios de nombres en una cabina de almacenamiento.' 
---
= Asigna un volumen E-Series con SANtricity System Manager para NVMe sobre RoCE
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. En el panel izquierdo de la interfaz de SANtricity System Manager, selecciona menú:Storage[Hosts].
...
.El futuro
Después de asignar un volumen, link:nvme-roce-display-volumes-visible-host-task.html["mostrar los volúmenes visibles al host"].
