...
summary: 'Puedes configurar la E/S dirigida al dispositivo de destino según tu versión de SLES (SUSE Linux version).' 
---
= Cómo E-Series redirige las operaciones de E/S a destinos NVMe físicos en Linux a través de InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Esto ya no funcionará en RHEL 10. Funciona en RHEL 9 y anteriores y SLES 16 y anteriores.
