...
---
= Crea un host E-Series para NVMe sobre RoCE en Linux
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Una vez creado el host, link:nvme-roce-assign-volume-task.html["asignar un volumen a través de SANtricity System Manager"].
