...
summary: 'Configura las E/S dirigidas al dispositivo de destino según tu versión de SLES (SUSE Linux version).' 
---
= Cómo E-Series redirige las entradas y salidas (I/O) a destinos NVMe virtuales en Linux a través de InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
En SLES 12, el host Linux dirige la E/S a los destinos de los dispositivos virtuales. DM-MP gestiona las rutas físicas subyacentes a estos objetivos virtuales.
