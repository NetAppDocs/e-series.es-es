...
---
= Configura las conexiones de red para los hosts Linux de E-Series usando iSER sobre IB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
*Red Hat Enterprise Linux 8, 9 y 10 (RHEL 8, RHEL 9 y RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12, 15 y 16 (SLES 12, SLES 15 y SLES 16)*
...
iscsiadm -m session
----
.. Comprueba el estado de la sesión iscsi desde la cabina. Desde SANtricity System Manager, ve a *Settings* > *System* > *View/End iSCSISessions*.
