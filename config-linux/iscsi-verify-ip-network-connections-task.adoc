...
summary: 'Para verificar las conexiones de red del Protocolo de Internet (IP), utilice las pruebas ping para asegurarse de que el host y la matriz pueden comunicarse.' 
---
= Verifica las conexiones de red IP en los hosts Linux E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
