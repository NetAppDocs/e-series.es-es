...
---
= Crear sistemas de archivos en volúmenes E-Series para hosts SLES 12 con NVMe sobre FC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para SLES 12, se crea un sistema de archivos en el dispositivo dm deseado y se monta el sistema de archivos.
