...
---
= Asignar un volumen a un host NVMe sobre TCP de Linux en E-Series
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de asignar un volumen, link:nvme-tcp-display-volumes-visible-host-task.html["mostrar los volúmenes visibles al host"].
