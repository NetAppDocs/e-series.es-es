...
---
= Configurar el almacenamiento usando SANtricity System Manager - Linux (NVMe over RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que configures el almacenamiento en SANtricity System Manager, link:nvme-roce-configure-switch-task.html["configurar los conmutadores"].
