...
---
= Configura la red iSCSI del lado del array para hosts Linux en E-Series
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Esta tarea describe cómo acceder a la configuración de puertos iSCSI desde la página Hardware de System Manager. También puedes acceder a la configuración desde menu:System[Settings > System > Configure iSCSI ports].
