...
---
= Configura un iniciador NVMe sobre FC en un host Linux en E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
El siguiente procedimiento es para RHEL 8, RHEL 9, SLES 12 y SLES 15 que utilizan HBA FC compatibles con NVMe/FC de Broadcom Emulex o QLogic. Para obtener más información sobre las versiones de estos sistemas operativos o HBA compatibles, consulte la página https://mysupport.netapp.com/matrix["Herramienta de matriz de interoperabilidad de NetApp"^].
