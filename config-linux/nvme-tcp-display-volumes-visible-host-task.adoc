...
---
= Mostrar los volúmenes visibles para un host Linux NVMe over TCP de E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
----
.El futuro
Una vez que hayas consultado los volúmenes disponibles, link:nvme-tcp-setup-failover-host-task.html["configurar la conmutación por error en el host"].
