...
summary: Para SLES 15, crea un sistema de archivos en el dispositivo nvme nativo y monta el sistema de archivos. 
---
= Crear sistemas de archivos en E-Series - Linux RHEL 8, RHEL 9, RHEL 10, SLES 15 y SLES 16 (NVMe sobre RoCE)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para RHEL 8, RHEL 9, RHEL 10, SLES 15 y SLES 16, crea un sistema de archivos en el dispositivo nvme nativo y monta el sistema de archivos.
