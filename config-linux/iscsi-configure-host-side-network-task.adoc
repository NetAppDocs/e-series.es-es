...
---
= Configura la red iSCSI del lado del host para hosts Linux en E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
----
+
*Red Hat Enterprise Linux 9 y 10 (RHEL 9 y RHEL 10) y SUSE Linux Enterprise Server 16 (SLES 16)*
