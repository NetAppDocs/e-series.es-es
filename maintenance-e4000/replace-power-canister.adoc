...
---
= Sustituye un módulo de alimentación en un shelf de 60 unidades E4000
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Es posible sustituir un contenedor de alimentación en una cabina E4000 por una bandeja de 60 unidades, que incluye los siguientes tipos de bandeja:
...
.. Cuando encuentres la estantería con un icono rojo, selecciona el canister de energía o el icono rojo de energía.
