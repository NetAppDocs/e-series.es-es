...
summary:  
---
= Sustituir una tarjeta de interfaz del host E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. En la página de inicio de SANtricity System Manager, selecciona el menú: Storage [Operations in Progress].
...
+
.. Selecciona *Almacenamiento › Volúmenes*. En la página *All Volumes*, comprueba que los volúmenes estén distribuidos a sus propietarios preferidos. Selecciona *icono de elipse › Cambiar titularidad* para ver los propietarios de los volúmenes.
