...
---
= Añade en caliente una bandeja de unidades E4000 con módulos IOM12 o IOM12B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. En SANtricity System Manager, selecciona el menú: Hardware[Controladores y componentes].
+
...
. En SANtricity System Manager, selecciona el menú: Hardware[Controladores y componentes] y desplázate hacia abajo, si es necesario, para ver la bandeja de unidades recién añadida.
