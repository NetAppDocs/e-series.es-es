...
summary:  
---
= Sustituir el controlador en un sistema de almacenamiento E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Selecciona el menú: Hardware [Controller and components].
...
.. Selecciona el icono de la elipse › Redistribute volumes.
