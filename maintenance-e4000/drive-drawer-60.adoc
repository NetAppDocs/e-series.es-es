...
summary: Es posible sustituir un cajón de unidades en una bandeja de controladoras E4060 o una bandeja de unidades DE460C. 
---
= Reemplaza la bandeja de unidades en un shelf E4000 de 60 unidades
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Determina si puedes llevar a cabo el procedimiento de sustitución mientras el bastidor de unidades está en línea o si necesitas detener la actividad de E/S del host y apagar cualquiera de los bastidores que estén encendidos (realizar el procedimiento fuera de línea).
...
. En el panel izquierdo de SANtricity System Manager, selecciona el menú: almacenamiento [Operaciones en curso].
...
Vuelve a insertar las unidades en el orden correcto, reinstala la bandeja de unidades en el estante de unidades, vuelve a colocar el frontal, vuelve a aplicar la alimentación (si es necesario) y luego reconstruye manualmente las unidades (si es necesario).
