...
+
... Seleccione *hardware*.
... Si el gráfico muestra las unidades, selecciona *Controller & Components* para mostrar los controladores
...
+
.. Selecciona *Storage › Volumes*. Desde la página *All Volumes*, verifica que los volúmenes estén distribuidos a sus propietarios preferidos. Selecciona *More › Change ownership* para ver los propietarios de los volúmenes
