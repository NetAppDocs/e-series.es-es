...
summary:  
---
= Sustituir la batería en un sistema de almacenamiento E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Selecciona el menú: Hardware [Controladores y componentes] para mostrar los controladores.
...
** Desde SANtricity System Manager:
+
... Selecciona el menú: Hardware [Controlador y componentes].
...
+
.. Selecciona *Almacenamiento › Volúmenes*. En la página *All Volumes*, comprueba que los volúmenes estén distribuidos a sus propietarios preferidos. Selecciona *icono de elipse › Cambiar titularidad del volumen* para ver los propietarios de los volúmenes.
.. Si todos los volúmenes pertenecen al propietario preferente, continúa con el paso 4.
.. Si no se ha devuelto ninguno de los volúmenes, debes devolver los volúmenes manualmente. Ve a *icono de la elipse › Redistribuir volúmenes*.
