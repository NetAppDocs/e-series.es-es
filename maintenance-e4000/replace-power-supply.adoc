...
---
= Sustituir una fuente de alimentación en un sistema de almacenamiento E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Cuando encuentres la estantería con un icono rojo, selecciona cualquiera de las dos fuentes de alimentación.
