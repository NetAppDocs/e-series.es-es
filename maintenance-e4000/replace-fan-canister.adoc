...
---
= Sustituir el compartimento del ventilador en una bandeja de 60 unidades E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Cuando encuentres la estantería con un icono rojo, selecciona el canister del ventilador o el icono rojo del ventilador.
