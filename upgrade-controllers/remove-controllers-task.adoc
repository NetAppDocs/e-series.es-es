...
[role="tabbed-block"]
====
.Modelos de controlador EF80 y EF50
--
Para obtener información sobre cómo quitar controladores de los sistemas de almacenamiento EF80 y EF50, consulta link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller["EF50 y EF80 - Paso 1: Retira el controlador"^].

--
.Otros modelos de controladora E-Series
--
[discrete]
=== Modelos de controladora E4000, E2800 y E5700
...
[discrete]
=== Modelos de controlador EF600 y EF300

Retira el cartucho del controlador para poder sustituirlo por uno nuevo.
...
+
Dado que debes retirar el HIC del antiguo módulo del controlador, debes retirar cualquier SFP de los puertos del HIC. Cuando vuelvas a conectar los cables, puedes mover esos SFP al nuevo módulo del controlador.
