...
[role="tabbed-block"]
====
.Modelos de controlador EF280 y EF50
--
Para obtener información sobre cómo quitar controladores de los sistemas de almacenamiento EF280 y EF50, consulta link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller["EF50 y EF80 - Paso 1: Retira el controlador"^].
