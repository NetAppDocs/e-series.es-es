...
--
Para obtener información sobre la instalación de nuevos controladores EF80 y EF50, consulta link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 y EF80 - Paso 7: instala el controlador"^].
