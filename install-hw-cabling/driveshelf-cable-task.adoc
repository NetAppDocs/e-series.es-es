...
---
= Conecta un shelf de controlador E-Series a un shelf de unidades
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si vas a conectar un sistema de almacenamiento EF50 o EF80 a bandejas de expansión SAS como parte de la instalación de un nuevo sistema, consulta el procedimiento link:../install-hw-ef50-ef80/install-cable.html["Cablea el hardware de los sistemas de almacenamiento EF50 y EF80"].
