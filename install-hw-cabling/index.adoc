...
---
= Cableado de tu sistema de almacenamiento - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
Para obtener información sobre el cableado necesario para las funciones de duplicación, consulta la  https://www.netapp.com/pdf.html?item=/media/17133-tr4656.pdf["Descripciones de las funciones de mirroring síncrono y asíncrono y guía de puesta en marcha"^].
