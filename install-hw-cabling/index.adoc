...
---
= Conoce el cableado de los sistemas de almacenamiento E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si no ves el estante de tu controlador (sistema de almacenamiento) en la lista de abajo, consulta link:../getting-started/getup-run-concept.html["Inicio rápido de E-Series"^] y haz clic en el enlace de tu sistema de almacenamiento específico para acceder a la información de cableado.
...
Si estás cableando para alguna de las siguientes configuraciones, consulta https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["Adición de bandejas de unidades IOM a una bandeja de controladoras E27XX, Safari o EF560 existente."^]
...
|===
Para obtener información sobre el cableado necesario para las funciones de duplicación, consulta la  https://www.netapp.com/pdf.html?item=/media/19405-tr-4839.pdf["Descripciones de las funciones de mirroring síncrono y asíncrono y guía de puesta en marcha"^].
