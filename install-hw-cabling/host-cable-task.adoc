...
---
= Cableado del host para controladores y switches E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: La siguiente información no se aplica a todos los sistemas de almacenamiento, para el cableado de host específico de tu sistema de almacenamiento, consulta link:../getting-started/getup-run-concept.html["Inicio rápido de E-Series"^] y haz clic en el enlace para tu sistema de almacenamiento específico.
