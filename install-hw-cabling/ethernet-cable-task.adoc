...
[NOTE]
====
Algunos sistemas de almacenamiento solo tienen un puerto de gestión Ethernet fuera de banda en cada controlador.

Para ver las instrucciones de cableado específicas para tu sistema de almacenamiento, consulta link:../getting-started/getup-run-concept.html["Inicio rápido de E-Series"^] y haz clic en el enlace de tu sistema de almacenamiento específico.
